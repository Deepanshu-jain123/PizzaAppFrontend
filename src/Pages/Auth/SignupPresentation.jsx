            ...
            <section className="text-gray-600 body-font">
                <div className="flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
                    ...
                    <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="mobileNumber" className="text-sm leading-7 text-gray-600">Mobile Number</label>
                            <span className="text-red-500">*</span>
                            <input 
                            type="tel" 
                            id="mobileNumber" 
                    ...
                    <button
                        ...
                        className="m-full px-0 py-2 text-lg text-white bg-yellow-500 border-0 rounded
                        focus:outline-none hover:bg-yellow-600">Create Account
                        </button>
                        <p className="mt-3 text-xx text-gray-500">Already have an account?
