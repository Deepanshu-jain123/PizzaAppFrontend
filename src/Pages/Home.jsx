        ...
        <div>
            ...
            >
                <div className="w-4/6 ml-4 text-center md:w-2/6 md:text-left">
                    ...
                    <button className="flex items-center px-4 py-2 text-white bg-yellow-500 rounded-md hover:bg-orange-600 group" >
                        Order Now
                        <span className="inline-block ml-5 transition-transform ease-in-out group-hover:translate-x-2">
                            <IconArrowRight/>
                        </span>
                    </button>
                </div>
