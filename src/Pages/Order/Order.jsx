            ...
            <section className="text-gray-600 body-font min-h-56">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium tittle-font mb-4 text-gray-900">
                            Thanks for Choosing Us{' '}
                        </h1>
                        <p className="lg:w-2/3 mx-auto leading-reloxed text-base">
                            Total Price -
                    ...
                    <form onSubmit={handleFormSubmit}>
                        <div className="relative flex-grow w-full">
                            <label htmlFor="paymentMethod" className="text-2xl leading text-gray-600">
                                Payment Method
                            </label>
                            <select name="paymentMethod"
                            required
                            onChange={handleUserInput}
                             className="p-2 border rounded-md w-full focus:outline-none focus:border-primary-500 bg-white text-gray-700">                                <option value="OFFLINE">Offline</option>
                        ...
                        <div className="relative flex-grow w-full my-5">
                            ...
                            required
                            onChange={handleUserInput}
                            className="w-full p-2 border rounded-md focus:outline-none focus:border-primary-500 bg-white text-gray-700"></textarea>
                        </div>
